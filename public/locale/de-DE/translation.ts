    ...
    about: {
      texts: {
        ...
        pahnkeGroup: {
          ...
          mediaVolumeTile: {
            amount: "100",
            description: "Millionen Euro Media-Volumen",
          },
        },
        caroussel: {
          element1: {
            subtext: "John Doe Geschäftsführer",
        ...
        managingDirectors: {
          ...
          member1: {
            name: "JOHN DOE",
            description: "Geschäftsführender Gesellschafter",
          },
          member2: {
            name: "PETER SMITH",
            description: "Geschäftsführender Gesellschafter",
